...
#line 61 "../../include/ztex.h"


#line 64 "../../include/ztex.h"
...
#line 403 "../../include/ztex-flash2.h"
    spi_write_byte(s & 255);
    spi_write_byte(0);
    spi_clocks(8);				// 8 dummy clocks
#line 406 "../../include/ztex-flash2.h"
    return 0;
} 
...
void flash_read_finish(WORD n) {
   n;					// avoids warnings
#line 428 "../../include/ztex-flash2.h"
   spi_deselect();
}
...
#line 437 "../../include/ztex-flash2.h"
...
#line 444 "../../include/ztex-flash2.h"
    spi_deselect();
...
#line 448 "../../include/ztex-flash2.h"
...
#line 464 "../../include/ztex-flash2.h"
	spi_need_pp = 1;
    }
    return 0;
}
...
/* *********************************************************************
   ...
   ********************************************************************* */
// write len (256 if len=0) bytes from the buffer to the flash
#line 474 "../../include/ztex-flash2.h"
BYTE flash_write(__xdata BYTE *buf, BYTE len) {
	...
	spi_write_addr_hi++;
	spi_deselect();				// finish write cmd
#line 499 "../../include/ztex-flash2.h"
	spi_need_pp = 1;
    }
...
BYTE flash_write_init(WORD s) {
	...
	flash_ec = 4;
	return 4;		// we interrupted a pending Flash operation
#line 518 "../../include/ztex-flash2.h"
    }  
    if ( spi_wait() ) {
	return flash_ec;
    }
...
#line 528 "../../include/ztex-flash2.h"
    spi_deselect();
...
/* *********************************************************************
   ...
   ********************************************************************* */
// init the flash
#line 581 "../../include/ztex-flash2.h"
void flash_init() {
    BYTE i;
...
#line 589 "../../include/ztex-flash2.h"
    spi_erase_cmd = 0xd8;
...
#line 595 "../../include/ztex-flash2.h"
...
#line 598 "../../include/ztex-flash2.h"
    spi_device = flash_read_byte();			
    spi_deselect();				// deselect
#line 600 "../../include/ztex-flash2.h"
...
#line 624 "../../include/ztex-flash2.h"
    i=spi_buffer[2]-16;
#line 626 "../../include/ztex-flash2.h"
    flash_sectors = 1 << i;
...
#line 650 "../../include/ztex-flash2.h"
...
#line 682 "../../include/ztex-flash2.h"
...
#line 719 "../../include/ztex-flash2.h"

#line 144 "../../include/ztex.h"
...
#line 25 "../../include/ztex-fpga6.h"

#line 27 "../../include/ztex-fpga6.h"
...
#line 32 "../../include/ztex-fpga6.h"

__xdata BYTE fpga_conf_initialized; // 123 if initialized
#line 34 "../../include/ztex-fpga6.h"
__xdata BYTE OOEC;
...
#line 70 "../../include/ztex-fpga6.h"
    ...
    OEC &= ~( 128 | 16);		// in: MOSI, MISO
    OEC |= 64;               	// out: CCLK
#line 79 "../../include/ztex-fpga6.h"
    IOC6 = 1;
//  in:       INIT_B  DONE 
//  OEE &= ~( bmBIT1 | bmBIT0 );
//  out:     CM0      CM1   RESET_N     CSI     RDWR
#line 83 "../../include/ztex-fpga6.h"
    OEE = 8 | 16 | 128 | 4 | 32;
    IOE = 8;
    
    wait(2);
    IOE = 8 | 128;		// ready for configuration
#line 88 "../../include/ztex-fpga6.h"
    IOC6 = 0;
...
static void finish_fpga_configuration () {
    BYTE w;
    fpga_init_b += (IOE & 2) ? 22 : 11;

    for ( w=0; w<64; w++ ) {
        IOC6 = 1; IOC6 = 0; 
    }
    IOE |= 4;		// CSI = 1
#line 117 "../../include/ztex-fpga6.h"
    IOC6 = 1; IOC6 = 0;
    IOC6 = 1; IOC6 = 0;
    IOC6 = 1; IOC6 = 0;
    IOC6 = 1; IOC6 = 0;
...
/* *********************************************************************
   ...
   ********************************************************************* */
#line 149 "../../include/ztex-fpga6.h"


/* *********************************************************************
   ***** EP0 vendor command 0x31 ***************************************
   ********************************************************************* */
#line 155 "../../include/ztex-fpga6.h"
...
#line 204 "../../include/ztex-fpga6.h"


#line 207 "../../include/ztex-fpga6.h"

#line 214 "../../include/ztex-fpga6.h"

#line 216 "../../include/ztex-fpga6.h"

/* *********************************************************************
   ***** EP0 vendor request 0x33 ***************************************
   ********************************************************************* */
#line 226 "../../include/ztex-fpga6.h"
...
void init_cpld_fpga_configuration() {
    IFCONFIG = 128 | 64 | 32 | 2;	// Internal source, 48MHz, GPIF
#line 251 "../../include/ztex-fpga6.h"

    GPIFREADYCFG = 0; //bmBIT7 | bmBIT6 | bmBIT5;
#line 253 "../../include/ztex-fpga6.h"
    GPIFCTLCFG = 0x0; 
    GPIFIDLECS = 0;
    GPIFIDLECTL = 4;
    GPIFWFSELECT = 0x4E;
...
#line 120 "../../include/ztex-utils.h"
    {
	AUTOPTRL1=((BYTE)(&(GPIF_WAVE_DATA_HSFPGA_24MHZ)));
	AUTOPTRH1=((BYTE)((((unsigned short)(&(GPIF_WAVE_DATA_HSFPGA_24MHZ)) >> 8) & 0xff)) );
	AUTOPTRL2=((BYTE)(&(GPIF_WAVE3_DATA)));
	AUTOPTRH2=((BYTE)((((unsigned short)(&(GPIF_WAVE3_DATA)) >> 8) & 0xff)) );
        __asm
		push	ar2
  		mov	r2,#(32);
...
#line 41 "../../include/ezregs.h"
	...
	nop 
    __endasm;
#line 277 "../../include/ztex-fpga6.h"
 

    EP2FIFOCFG = 0;		// config fifo
#line 41 "../../include/ezregs.h"
    __asm 
	nop 
	nop 
...
#line 41 "../../include/ezregs.h"
	...
	nop 
    __endasm;
#line 293 "../../include/ztex-fpga6.h"

    
    EP2GPIFTRIG = 0xff;		// arm fifos
#line 41 "../../include/ezregs.h"
    __asm 
	nop 
	nop 
	...
	nop 
    __endasm;
#line 296 "../../include/ztex-fpga6.h"

    
    OEC &= ~64;				// disable CCLK output
    IOE = 16 | 128;		        // HS config mode
#line 300 "../../include/ztex-fpga6.h"
}


#line 313 "../../include/ztex-fpga6.h"


/* *********************************************************************
   ***** EP0 vendor command 0x35 ***************************************
   ********************************************************************* */
#line 329 "../../include/ztex-fpga6.h"

#line 331 "../../include/ztex-fpga6.h"

#line 333 "../../include/ztex-fpga6.h"
/* *********************************************************************
...
BYTE fpga_configure_from_flash( BYTE force) {
    ...
    c = OEC;
    OEC &= ~( 32 | 128 | 64 );	// disable SPI outputs
#line 364 "../../include/ztex-fpga6.h"
...
#line 377 "../../include/ztex-fpga6.h"
    wait(10);
    for (i=0; (IOE & 2) && (IOC5==0) && i<10000; i++ ) { 
	wait(1);
    }
	...
	IOE =  8 | 16;	// leave master SPI config mode
#line 389 "../../include/ztex-fpga6.h"
	wait(1);
	fpga_flash_result = 4;
    }
    OEE = 0;
...
#line 401 "../../include/ztex-fpga6.h"

#line 403 "../../include/ztex-fpga6.h"


#line 171 "../../include/ztex.h"

#line 173 "../../include/ztex.h"


/* *********************************************************************
   ***** DEBUG helper functions ****************************************
   ********************************************************************* */
#line 181 "../../include/ztex.h"


/* *********************************************************************
   ***** XMEGA support *************************************************
   ********************************************************************* */
#line 187 "../../include/ztex.h"
...
#line 101 "../../include/ztex-descriptors.h"

#line 105 "../../include/ztex-descriptors.h"

/* Prepare the Interfaces, i.e. check which interfaces are defined */
#line 122 "../../include/ztex-descriptors.h"
...
//Interface 3: NO
#line 127 "../../include/ztex-descriptors.h"

/* define the ZTEX descriptor */
void abscode_identity()// _naked
#line 130 "../../include/ztex-descriptors.h"
{
    __asm	
    .area ABSCODE (ABS,CODE)
...
#line 183 "../../include/ztex-descriptors.h"
    .db 0 + 1 + 2 + 4 + 32 + 64
#line 189 "../../include/ztex-descriptors.h"
    .db 0
    .db 0
    .db 0
    .db 0
...
__code char productString[] = "USB-FPGA Module 2.13  (default)";
...
/* *********************************************************************
   ***** descriptors ***************************************************
   ********************************************************************* */
#line 269 "../../include/ztex-descriptors.h"
   
#line 333 "../../include/ztex-descriptors.h"

#line 335 "../../include/ztex-descriptors.h"

#line 337 "../../include/ztex-descriptors.h"
__code BYTE PadByte = 0;
#line 339 "../../include/ztex-descriptors.h"
...
#line 360 "../../include/ztex-descriptors.h"
    };
...
#line 293 "../../include/ztex-descriptors.h"
	  +1
#line 296 "../../include/ztex-descriptors.h"
	  +1
#line 299 "../../include/ztex-descriptors.h"
	  +1
	,0xff	// 5, Interface class
	,0xff	// 6, Interface sub class
	,0xff   // 7, Interface protocol
	,0 	// 8, Index of interface string descriptor
#line 227 "../../include/ztex-descriptors.h"
...
#line 315 "../../include/ztex-descriptors.h"
...
#line 227 "../../include/ztex-descriptors.h"
	...
	,512 >> 8 	// 5, max. packet size (H) 
	,0 			// 6, Polling interval
#line 318 "../../include/ztex-descriptors.h"
...
#line 227 "../../include/ztex-descriptors.h"
	...
	,7 			// 0, Descriptor length
	,5			// 1, Descriptor type
	,2			// 2, direction=input, address=2
	,2			// 3, BULK transferns
	,512 & 0xff 	// 4, max. packet size (L) 
	,512 >> 8 	// 5, max. packet size (H) 
	,0 			// 6, Polling interval
#line 321 "../../include/ztex-descriptors.h"

#line 403 "../../include/ztex-descriptors.h"
...
//	,sizeof(FullSpeedConfigDescriptor) >> 8		// 3, Total length (MSB)
	,0						// 3, To avoid warnings, descriptor length will never exceed 255 bytes
	,0	// 4, Number of Interfaces
#line 427 "../../include/ztex-descriptors.h"
	  +1
#line 438 "../../include/ztex-descriptors.h"
...
#line 444 "../../include/ztex-descriptors.h"

#line 455 "../../include/ztex-descriptors.h"
    };
...
#line 462 "../../include/ztex-descriptors.h"
	0, 0
    };
...
#line 694 "../../include/ztex-flash2.h"
...
#line 138 "../../include/ztex-conf.h"
    ...
    break;
#line 696 "../../include/ztex-flash2.h"
}
    }
#line 124 "../../include/ztex-conf.h"
...
#line 304 "../../include/ztex-fpga6.h"
    init_fpga_configuration();

    EP2CS &= ~1;		// clear stall bit
#line 307 "../../include/ztex-fpga6.h"

    GPIFABORT = 0xFF;				// abort pendig 
#line 309 "../../include/ztex-fpga6.h"
...
#line 319 "../../include/ztex-fpga6.h"
    IOE = 8 | 128;		
    OEC |= 64;               	// out: CCLK
#line 321 "../../include/ztex-fpga6.h"
...
case 0x40:
#line 641 "../../include/ztex-flash2.h"
    
    if ( flash_ec == 0 && IOC5 == 0 ) {
	flash_ec = 4;
    }
#line 120 "../../include/ztex-utils.h"
    {
...
case 0x41:
    			// read data
#line 667 "../../include/ztex-flash2.h"
...
#line 138 "../../include/ztex-conf.h"
    ep0_payload_remaining = 0;
    break;
#line 669 "../../include/ztex-flash2.h"
}
    }  
    spi_read_ep0();  
    EP0BCH = 0;
...
case 0x43:
#line 713 "../../include/ztex-flash2.h"
...
#line 120 "../../include/ztex-utils.h"
	...
	AUTOPTRH2=((BYTE)((((unsigned short)(&(EP0BUF)) >> 8) & 0xff)) );
		...
		pop	ar2
        __endasm; 
#line 714 "../../include/ztex-flash2.h"
}	
    EP0BCH = 0;
    EP0BCL = 10;
#line 101 "../../include/ztex-conf.h"
...
case 0x33:
    		// get high speed fpga configuration endpoint and interface 
    EP0BUF[0] = 2;	// endpoint
    EP0BUF[1] = 0; // interface
#line 223 "../../include/ztex-fpga6.h"
    EP0BCH = 0;
    EP0BCL = 2;
#line 101 "../../include/ztex-conf.h"
...
case 0x40:
#line 648 "../../include/ztex-flash2.h"
...
case 0x41:
#line 674 "../../include/ztex-flash2.h"
...
#line 138 "../../include/ztex-conf.h"
    ep0_payload_remaining = 0;
    break;
#line 704 "../../include/ztex-flash2.h"
}
	} 
    } 
#line 129 "../../include/ztex-conf.h"
...
#line 272 "../../include/ztex.h"


/* *********************************************************************
   ***** init_USB ******************************************************
   ********************************************************************* */
#line 303 "../../include/ztex.h"

#line 315 "../../include/ztex.h"
...
#line 348 "../../include/ztex.h"
    init_fpga();
#line 350 "../../include/ztex.h"

#line 104 "../../include/ztex-fpga-flash2.h"
    
fpga_flash_result= 255;
#line 351 "../../include/ztex.h"
...
#line 41 "../../include/ezregs.h"
	...
	nop 
    __endasm;
#line 313 "../../include/ztex.h"

#line 384 "../../include/ztex.h"
...
#line 385 "../../include/ztex.h"

#line 277 "../../include/ztex.h"
        EP2CFG = 
#line 281 "../../include/ztex.h"
	128
#line 286 "../../include/ztex.h"
	| 32 
...
#line 41 "../../include/ezregs.h"
	...
	nop 
    __endasm;
#line 301 "../../include/ztex.h"

#line 386 "../../include/ztex.h"

#line 277 "../../include/ztex.h"
        EP4CFG = 
#line 283 "../../include/ztex.h"
	0
#line 300 "../../include/ztex.h"
	;
#line 41 "../../include/ezregs.h"
