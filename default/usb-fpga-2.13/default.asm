...
; This file was generated Wed Dec  4 01:40:19 2013
;--------------------------------------------------------
	.module default_tmp
...
_flash_read_init:
	mov	r2,dpl
	mov	r3,dph
;	../../include/ztex-flash2.h:400: s = s << ((BYTE)flash_sector_size - 8);     
	jb	_IOC5,00102$
...
;	../../include/ztex-flash2.h:394: return FLASH_EC_PENDING;		// we interrupted a pending Flash operation
	...
	ret
00102$:
;	../../include/ztex-flash2.h:396: if ( spi_wait() ) {
	push	ar2
	push	ar3
	lcall	_spi_wait
	mov	a,dpl
	...
	pop	ar2
	jz	00104$
;	../../include/ztex-flash2.h:397: return flash_ec;
	mov	dptr,#_flash_ec
	movx	a,@dptr
	mov	dpl,a
	ret
...
;	../../include/ztex-flash2.h:363: 
	...
	pop	ar3
	pop	ar2
;	../../include/ztex-flash2.h:403: spi_write_byte(s & 255);
	mov	dpl,r2
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:404: spi_write_byte(0);
	mov	dpl,#0x00
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:405: spi_clocks(8);				// 8 dummy clocks
	mov	dpl,#0x08
	lcall	_spi_clocks
;	../../include/ztex-flash2.h:406: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:415: BYTE flash_read_next() {
;	-----------------------------------------
;	 function flash_read_next
;	-----------------------------------------
_flash_read_next:
;	../../include/ztex-flash2.h:416: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../include/ztex-flash2.h:426: void flash_read_finish(WORD n) {
;	-----------------------------------------
;	 function flash_read_finish
;	-----------------------------------------
_flash_read_finish:
;	../../include/ztex-flash2.h:428: spi_deselect();
	ljmp	_spi_deselect
;------------------------------------------------------------
;Allocation info for local variables in function 'spi_pp'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:435: BYTE spi_pp () {	
;	-----------------------------------------
;	 function spi_pp
;	-----------------------------------------
_spi_pp:
;	../../include/ztex-flash2.h:436: spi_deselect();				// finish previous write cmd
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:438: spi_need_pp = 0;
	mov	dptr,#_spi_need_pp
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:440: if ( spi_wait() ) {
	lcall	_spi_wait
	mov	a,dpl
	jz	00102$
;	../../include/ztex-flash2.h:441: return flash_ec;
	mov	dptr,#_flash_ec
	movx	a,@dptr
	mov	dpl,a
	ret
...
;	../../include/ztex-flash2.h:361: spi_write_byte($0);				// CMD 90h
	mov	dpl,#0x06
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:444: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:359: spi_last_cmd = $0;
	mov	dptr,#_spi_last_cmd
	mov	a,#0x02
...
;	../../include/ztex-flash2.h:363: 
	...
	mov	dpl,a
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:448: spi_write_byte(spi_write_addr_hi & 255);
	mov	dptr,#_spi_write_addr_hi
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	mov	dpl,r2
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:449: spi_write_byte(0);
	mov	dpl,#0x00
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:450: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;b                         Allocated to registers r2 
;------------------------------------------------------------
;	../../include/ztex-flash2.h:457: BYTE flash_write_byte (BYTE b) {
;	-----------------------------------------
;	 function flash_write_byte
;	-----------------------------------------
_flash_write_byte:
	mov	r2,dpl
;	../../include/ztex-flash2.h:458: if ( spi_need_pp && spi_pp() ) return flash_ec;
	mov	dptr,#_spi_need_pp
	movx	a,@dptr
	mov	r3,a
	jz	00102$
	...
	ret
00102$:
;	../../include/ztex-flash2.h:459: spi_write_byte(b);
	mov	dpl,r2
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:460: spi_write_addr_lo++;
	mov	dptr,#_spi_write_addr_lo
	movx	a,@dptr
	mov	dptr,#_spi_write_addr_lo
	inc	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:461: if ( spi_write_addr_lo == 0 ) {
	mov	dptr,#_spi_write_addr_lo
	movx	a,@dptr
	mov	r2,a
	jnz	00105$
;	../../include/ztex-flash2.h:462: spi_write_addr_hi++;
	mov	dptr,#_spi_write_addr_hi
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../include/ztex-flash2.h:463: spi_deselect();				// finish write cmd
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:464: spi_need_pp = 1;
	mov	dptr,#_spi_need_pp
	mov	a,#0x01
	movx	@dptr,a
00105$:
;	../../include/ztex-flash2.h:466: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../include/ztex-flash2.h:474: BYTE flash_write(__xdata BYTE *buf, BYTE len) {
;	-----------------------------------------
...
_flash_write:
	mov	r2,dpl
	mov	r3,dph
;	../../include/ztex-flash2.h:476: if ( spi_need_pp && spi_pp() ) return flash_ec;
	mov	dptr,#_spi_need_pp
	movx	a,@dptr
	mov	r4,a
	jz	00102$
	...
	ret
00102$:
;	../../include/ztex-flash2.h:478: if ( spi_write_addr_lo == 0 ) {
	mov	dptr,#_spi_write_addr_lo
	movx	a,@dptr
	mov	r4,a
	jnz	00110$
;	../../include/ztex-flash2.h:479: spi_write(buf,len);
	...
	sjmp	00111$
00110$:
;	../../include/ztex-flash2.h:482: b = (~spi_write_addr_lo) + 1;
	mov	a,r4
	cpl	a
	mov	r4,a
	inc	r4
;	../../include/ztex-flash2.h:483: if ( len==0 || len>b ) {
	...
	jnc	00107$
00106$:
;	../../include/ztex-flash2.h:484: spi_write(buf,b);
	...
	pop	ar3
	pop	ar2
;	../../include/ztex-flash2.h:485: len-=b;
	mov	a,_flash_write_PARM_2
	clr	c
	subb	a,r4
	mov	_flash_write_PARM_2,a
;	../../include/ztex-flash2.h:486: spi_write_addr_hi++;
	mov	dptr,#_spi_write_addr_hi
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../include/ztex-flash2.h:487: spi_write_addr_lo=0;
	mov	dptr,#_spi_write_addr_lo
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:488: buf+=b;
	mov	a,r4
	add	a,r2
	mov	r2,a
	clr	a
	addc	a,r3
	mov	r3,a
;	../../include/ztex-flash2.h:489: if ( spi_pp() ) return flash_ec;
	push	ar2
	push	ar3
	lcall	_spi_pp
	mov	a,dpl
	...
	ret
00107$:
;	../../include/ztex-flash2.h:491: spi_write(buf,len);
	mov	_spi_write_PARM_2,_flash_write_PARM_2
	mov	dpl,r2
	mov	dph,r3
	lcall	_spi_write
00111$:
;	../../include/ztex-flash2.h:494: spi_write_addr_lo+=len;
	mov	dptr,#_spi_write_addr_lo
	movx	a,@dptr
	mov	r2,a
	mov	a,_flash_write_PARM_2
	add	a,r2
	movx	@dptr,a
;	../../include/ztex-flash2.h:496: if ( spi_write_addr_lo == 0 ) {
	mov	dptr,#_spi_write_addr_lo
	movx	a,@dptr
	mov	r2,a
	jnz	00113$
;	../../include/ztex-flash2.h:497: spi_write_addr_hi++;
	mov	dptr,#_spi_write_addr_hi
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../include/ztex-flash2.h:498: spi_deselect();				// finish write cmd
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:499: spi_need_pp = 1;
	mov	dptr,#_spi_need_pp
	mov	a,#0x01
	movx	@dptr,a
00113$:
;	../../include/ztex-flash2.h:502: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;s                         Allocated to registers r2 r3 
;------------------------------------------------------------
;	../../include/ztex-flash2.h:514: BYTE flash_write_init(WORD s) {
;	-----------------------------------------
...
_flash_write_init:
	mov	r2,dpl
	mov	r3,dph
;	../../include/ztex-flash2.h:515: if ( !SPI_CS ) {
	jb	_IOC5,00102$
;	../../include/ztex-flash2.h:516: flash_ec = FLASH_EC_PENDING;
	mov	dptr,#_flash_ec
	mov	a,#0x04
	movx	@dptr,a
;	../../include/ztex-flash2.h:517: return FLASH_EC_PENDING;		// we interrupted a pending Flash operation
	mov	dpl,#0x04
	ret
00102$:
;	../../include/ztex-flash2.h:519: if ( spi_wait() ) {
	push	ar2
	push	ar3
	lcall	_spi_wait
	mov	a,dpl
	...
	pop	ar2
	jz	00104$
;	../../include/ztex-flash2.h:520: return flash_ec;
	mov	dptr,#_flash_ec
	movx	a,@dptr
	mov	dpl,a
	ret
00104$:
;	../../include/ztex-flash2.h:522: spi_write_sector = s;
	...
	mov	a,r3
	movx	@dptr,a
;	../../include/ztex-flash2.h:523: s = s << ((BYTE)flash_sector_size - 8);     
	mov	dptr,#_flash_sector_size
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
00112$:
	djnz	b,00111$
;	../../include/ztex-flash2.h:524: spi_write_addr_hi = s;
	mov	dptr,#_spi_write_addr_hi
	mov	a,r2
	movx	@dptr,a
	inc	dptr
	mov	a,r3
	movx	@dptr,a
;	../../include/ztex-flash2.h:525: spi_write_addr_lo = 0;
	mov	dptr,#_spi_write_addr_lo
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:359: spi_last_cmd = $0;
...
;	../../include/ztex-flash2.h:361: spi_write_byte($0);				// CMD 90h
	mov	dpl,#0x06
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:528: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:359: spi_last_cmd = $0;
...
;	../../include/ztex-flash2.h:363: 
	...
	pop	ar3
	pop	ar2
;	../../include/ztex-flash2.h:532: spi_write_byte(s & 255);
	mov	dpl,r2
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:533: spi_write_byte(0);
	mov	dpl,#0x00
	lcall	_spi_write_byte
;	../../include/ztex-flash2.h:534: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:536: spi_need_pp = 1;
	mov	dptr,#_spi_need_pp
	mov	a,#0x01
	movx	@dptr,a
;	../../include/ztex-flash2.h:537: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;n                         Allocated to registers 
;------------------------------------------------------------
;	../../include/ztex-flash2.h:547: BYTE flash_write_finish_sector (WORD n) {
;	-----------------------------------------
;	 function flash_write_finish_sector
;	-----------------------------------------
_flash_write_finish_sector:
;	../../include/ztex-flash2.h:549: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:550: return 0;
	mov	dpl,#0x00
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:560: void flash_write_finish () {
;	-----------------------------------------
;	 function flash_write_finish
;	-----------------------------------------
_flash_write_finish:
;	../../include/ztex-flash2.h:561: spi_deselect();
	ljmp	_spi_deselect
;------------------------------------------------------------
;Allocation info for local variables in function 'flash_write_next'
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:571: BYTE flash_write_next () {
;	-----------------------------------------
;	 function flash_write_next
;	-----------------------------------------
_flash_write_next:
;	../../include/ztex-flash2.h:572: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:573: return flash_write_init(spi_write_sector+1);
	mov	dptr,#_spi_write_sector
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
;------------------------------------------------------------
;	../../include/ztex-flash2.h:581: void flash_init() {
;	-----------------------------------------
;	 function flash_init
;	-----------------------------------------
_flash_init:
;	../../include/ztex-flash2.h:584: PORTCCFG = 0;
	mov	dptr,#_PORTCCFG
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:586: flash_enabled = 1;
	mov	dptr,#_flash_enabled
	mov	a,#0x01
	movx	@dptr,a
;	../../include/ztex-flash2.h:587: flash_ec = 0;
	mov	dptr,#_flash_ec
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:588: flash_sector_size = 0x8010;  // 64 KByte
	mov	dptr,#_flash_sector_size
	mov	a,#0x10
	movx	@dptr,a
	inc	dptr
	mov	a,#0x80
	movx	@dptr,a
;	../../include/ztex-flash2.h:589: spi_erase_cmd = 0xd8;
	mov	dptr,#_spi_erase_cmd
	mov	a,#0xD8
	movx	@dptr,a
;	../../include/ztex-flash2.h:591: OESPI_OPORT &= ~bmBITSPI_BIT_DO;
	anl	_OEC,#0xEF
;	../../include/ztex-flash2.h:592: OESPI_PORT |= bmBITSPI_BIT_CS | bmBITSPI_BIT_DI | bmBITSPI_BIT_CLK;
	orl	_OEC,#0xE0
;	../../include/ztex-flash2.h:593: SPI_CS = 1;
	setb	_IOC5
;	../../include/ztex-flash2.h:594: spi_clocks(0);				// 256 clocks
	mov	dpl,#0x00
	lcall	_spi_clocks
;	../../include/ztex-flash2.h:359: spi_last_cmd = $0;
	mov	dptr,#_spi_last_cmd
...
;	../../include/ztex-flash2.h:363: 
	mov	dpl,#0x18
	lcall	_spi_clocks
;	../../include/ztex-flash2.h:598: spi_device = flash_read_byte();			
	lcall	_flash_read_byte
	mov	a,dpl
	mov	dptr,#_spi_device
	movx	@dptr,a
;	../../include/ztex-flash2.h:599: spi_deselect();				// deselect
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:359: spi_last_cmd = $0;
	mov	dptr,#_spi_last_cmd
	mov	a,#0x9F
...
;	../../include/ztex-flash2.h:364: /* *********************************************************************
	lcall	_spi_deselect
;	../../include/ztex-flash2.h:604: if ( spi_buffer[2]<16 || spi_buffer[2]>24 ) {
...
00109$:
	...
	add	a,#0xff - 0x18
	jc	00104$
;	../../include/ztex-flash2.h:607: spi_vendor = spi_buffer[0];
	mov	dptr,#_spi_buffer
	movx	a,@dptr
	mov	dptr,#_spi_vendor
	movx	@dptr,a
;	../../include/ztex-flash2.h:608: spi_memtype = spi_buffer[1];
	mov	dptr,#(_spi_buffer + 0x0001)
	movx	a,@dptr
	mov	dptr,#_spi_memtype
	movx	@dptr,a
;	../../include/ztex-flash2.h:624: i=spi_buffer[2]-16;
	mov	a,r2
	add	a,#0xf0
	mov	r2,a
;	../../include/ztex-flash2.h:626: flash_sectors = 1 << i;
	mov	b,r2
	inc	b
	mov	r2,#0x01
	mov	r3,#0x00
...
00113$:
	...
	inc	dptr
	movx	@dptr,a
;	../../include/ztex-flash2.h:628: return;
;	../../include/ztex-flash2.h:630: disable:
	ret
00104$:
;	../../include/ztex-flash2.h:631: flash_enabled = 0;
	mov	dptr,#_flash_enabled
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:632: flash_ec = FLASH_EC_NOTSUPPORTED;
	mov	dptr,#_flash_ec
	mov	a,#0x07
	movx	@dptr,a
;	../../include/ztex-flash2.h:633: OESPI_PORT &= ~( bmBITSPI_BIT_CS | bmBITSPI_BIT_DI | bmBITSPI_BIT_CLK );
	anl	_OEC,#0x1F
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:659: void spi_read_ep0 () { 
;	-----------------------------------------
;	 function spi_read_ep0
;	-----------------------------------------
_spi_read_ep0:
;	../../include/ztex-flash2.h:660: flash_read(EP0BUF, ep0_payload_transfer);
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	_flash_read_PARM_2,a
	mov	dptr,#_EP0BUF
	lcall	_flash_read
;	../../include/ztex-flash2.h:661: if ( ep0_read_mode==2 && ep0_payload_remaining==0 ) {
	...
	orl	a,r2
	jnz	00104$
;	../../include/ztex-flash2.h:662: spi_deselect();
	ljmp	_spi_deselect
00104$:
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-flash2.h:686: void spi_send_ep0 () { 
;	-----------------------------------------
;	 function spi_send_ep0
;	-----------------------------------------
_spi_send_ep0:
;	../../include/ztex-flash2.h:687: flash_write(EP0BUF, ep0_payload_transfer);
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	_flash_write_PARM_2,a
	mov	dptr,#_EP0BUF
	lcall	_flash_write
;	../../include/ztex-flash2.h:688: if ( ep0_write_mode==2 && ep0_payload_remaining==0 ) {
	...
	orl	a,r2
	jnz	00104$
;	../../include/ztex-flash2.h:689: spi_deselect();
	ljmp	_spi_deselect
00104$:
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;oOEB                      Allocated with name '_fpga_send_ep0_oOEB_1_1'
;------------------------------------------------------------
...
;	../../include/ztex-fpga6.h:162: oOEB = OEB;
	mov	_fpga_send_ep0_oOEB_1_1,_OEB
...
;	../../include/ztex-fpga6.h:193: if ( EP0BCL<64 ) {
	mov	_OEB,_fpga_send_ep0_oOEB_1_1
...
;	../../include/ztex-fpga6.h:250: IFCONFIG = bmBIT7 | bmBIT6 | bmBIT5 | 2;	// Internal source, 48MHz, GPIF
	mov	dptr,#_IFCONFIG
	mov	a,#0xE2
	movx	@dptr,a
;	../../include/ztex-fpga6.h:252: GPIFREADYCFG = 0; //bmBIT7 | bmBIT6 | bmBIT5;
...
;	../../include/ztex-utils.h:122: AUTOPTRH1=HI(&($0));
	mov	r2,#_GPIF_WAVE_DATA_HSFPGA_24MHZ
	mov	r3,#(_GPIF_WAVE_DATA_HSFPGA_24MHZ >> 8)
	mov	_AUTOPTRH1,r3
...
;------------------------------------------------------------
;	../../include/ztex-fpga6.h:351: BYTE fpga_configure_from_flash( BYTE force) {
;	-----------------------------------------
;	 function fpga_configure_from_flash
;	-----------------------------------------
_fpga_configure_from_flash:
;	../../include/ztex-fpga6.h:355: if ( ( force == 0 ) && ( IOE & bmBIT0 ) ) {
	mov	a,dpl
	mov	r2,a
	jnz	00102$
	mov	a,_IOE
	jnb	acc.0,00102$
;	../../include/ztex-fpga6.h:356: fpga_flash_result = 1;
	mov	dptr,#_fpga_flash_result
	mov	a,#0x01
	movx	@dptr,a
;	../../include/ztex-fpga6.h:357: return 1;
	mov	dpl,#0x01
	ret
00102$:
;	../../include/ztex-fpga6.h:360: fpga_flash_result = 0;
	mov	dptr,#_fpga_flash_result
	clr	a
	movx	@dptr,a
;	../../include/ztex-fpga6.h:362: c = OESPI_PORT;
	mov	r2,_OEC
;	../../include/ztex-fpga6.h:363: OESPI_PORT &= ~( bmBITSPI_BIT_CS | bmBITSPI_BIT_DI | bmBITSPI_BIT_CLK );	// disable SPI outputs
	anl	_OEC,#0x1F
;	../../include/ztex-fpga6.h:371: OEE = bmBIT3 | bmBIT4 | bmBIT7;
	mov	_OEE,#0x98
;	../../include/ztex-fpga6.h:372: IOE = 0;
	mov	_IOE,#0x00
;	../../include/ztex-fpga6.h:373: wait(1);
	mov	dptr,#0x0001
	push	ar2
	lcall	_wait
;	../../include/ztex-fpga6.h:374: IOE = bmBIT7;
	mov	_IOE,#0x80
;	../../include/ztex-fpga6.h:377: wait(10);
	mov	dptr,#0x000A
	lcall	_wait
	pop	ar2
;	../../include/ztex-fpga6.h:378: for (i=0; (IOE & bmBIT1) && (SPI_CS==0) && i<10000; i++ ) { 
	mov	r3,#0x00
	mov	r4,#0x00
00109$:
	mov	a,_IOE
	...
	subb	a,#0x27
	jnc	00112$
;	../../include/ztex-fpga6.h:379: wait(1);
	mov	dptr,#0x0001
	push	ar2
	push	ar3
	push	ar4
...
;	../../include/ztex-fpga6.h:378: for (i=0; (IOE & bmBIT1) && (SPI_CS==0) && i<10000; i++ ) { 
	...
	sjmp	00109$
00112$:
;	../../include/ztex-fpga6.h:382: wait(1);
	mov	dptr,#0x0001
	push	ar2
	lcall	_wait
	pop	ar2
;	../../include/ztex-fpga6.h:384: if ( IOE & bmBIT0 )  {
	mov	a,_IOE
	jnb	acc.0,00105$
;	../../include/ztex-fpga6.h:385: post_fpga_config();
	push	ar2
	lcall	_post_fpga_config
	pop	ar2
	sjmp	00106$
00105$:
;	../../include/ztex-fpga6.h:388: IOE =  bmBIT3 | bmBIT4;	// leave master SPI config mode
	mov	_IOE,#0x18
;	../../include/ztex-fpga6.h:389: wait(1);
	mov	dptr,#0x0001
	push	ar2
	lcall	_wait
	pop	ar2
;	../../include/ztex-fpga6.h:390: fpga_flash_result = 4;
	mov	dptr,#_fpga_flash_result
	mov	a,#0x04
	movx	@dptr,a
00106$:
;	../../include/ztex-fpga6.h:392: OEE = 0;
	mov	_OEE,#0x00
;	../../include/ztex-fpga6.h:394: OESPI_PORT = c;
	mov	_OEC,r2
;	../../include/ztex-fpga6.h:395: SPI_CS = 1;
	setb	_IOC5
;	../../include/ztex-fpga6.h:397: return fpga_flash_result;
	mov	dptr,#_fpga_flash_result
	movx	a,@dptr
	mov	dpl,a
	ret
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex-descriptors.h:129: void abscode_identity()// _naked
;	-----------------------------------------
;	 function abscode_identity
;	-----------------------------------------
_abscode_identity:
;	../../include/ztex-descriptors.h:183: + 64
...
;	# 183 "../../include/ztex-descriptors.h"
	    .db 0 + 1 + 2 + 4 + 32 + 64
;	# 189 "../../include/ztex-descriptors.h"
	    .db 0
	    .db 0
	    .db 0
	    .db 0
...
;	../../include/ztex-conf.h:123: case $0:			
00103$:
;	../../include/ztex-flash2.h:694: ep0_write_mode = SETUPDAT[5];
	mov	dptr,#(_SETUPDAT + 0x0005)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_ep0_write_mode
	movx	@dptr,a
;	../../include/ztex-flash2.h:695: if ( (ep0_write_mode == 0) && flash_write_init((SETUPDAT[3] << 8) | SETUPDAT[2]) ) {
	mov	a,r2
	jz	00134$
	ret
00134$:
...
;	../../include/ztex-conf.h:100: case $0:
00167$:
;	../../include/ztex-flash2.h:642: if ( flash_ec == 0 && SPI_CS == 0 ) {
	mov	dptr,#_flash_ec
	movx	a,@dptr
	mov	r2,a
	jnz	00169$
	jb	_IOC5,00169$
;	../../include/ztex-flash2.h:643: flash_ec = FLASH_EC_PENDING;
	mov	dptr,#_flash_ec
	mov	a,#0x04
	movx	@dptr,a
00169$:
...
;	../../include/ztex-flash2.h:646: EP0BCH = 0;
	mov	dptr,#_EP0BCH
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:647: EP0BCL = 8;
	mov	dptr,#_EP0BCL
	mov	a,#0x08
	movx	@dptr,a
;	../../include/ztex-conf.h:102: break;
...
;	../../include/ztex-conf.h:100: case $0:
00171$:
;	../../include/ztex-flash2.h:667: ep0_read_mode = SETUPDAT[5];
	mov	dptr,#(_SETUPDAT + 0x0005)
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_ep0_read_mode
	movx	@dptr,a
;	../../include/ztex-flash2.h:668: if ( (ep0_read_mode==0) && flash_read_init((SETUPDAT[3] << 8) | SETUPDAT[2]) ) {
	mov	a,r2
	jnz	00173$
	mov	dptr,#(_SETUPDAT + 0x0003)
	movx	a,@dptr
...
;	../../include/ztex-conf.h:139: break;
	ljmp	00187$
00173$:
;	../../include/ztex-flash2.h:671: spi_read_ep0();  
	lcall	_spi_read_ep0
;	../../include/ztex-flash2.h:672: EP0BCH = 0;
	mov	dptr,#_EP0BCH
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:673: EP0BCL = ep0_payload_transfer; 
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_EP0BCL
...
;	../../include/ztex-flash2.h:715: EP0BCH = 0;
	mov	dptr,#_EP0BCH
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:716: EP0BCL = 10;
	mov	dptr,#_EP0BCL
	mov	a,#0x0A
	movx	@dptr,a
;	../../include/ztex-conf.h:102: break;
...
;	../../include/ztex-conf.h:105: case $0:
	sjmp	00113$
00106$:
;	../../include/ztex-flash2.h:675: if ( ep0_payload_transfer != 0 ) {
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	r2,a
	jz	00108$
;	../../include/ztex-flash2.h:676: flash_ec = 0;
	mov	dptr,#_flash_ec
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:677: spi_read_ep0(); 
	lcall	_spi_read_ep0
00108$:
;	../../include/ztex-flash2.h:679: EP0BCH = 0;
	mov	dptr,#_EP0BCH
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:680: EP0BCL = ep0_payload_transfer;
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	r2,a
	mov	dptr,#_EP0BCL
...
;	../../include/ztex-conf.h:128: case $0:			
	sjmp	00114$
00105$:
;	../../include/ztex-flash2.h:699: if ( ep0_payload_transfer != 0 ) {
	mov	dptr,#_ep0_payload_transfer
	movx	a,@dptr
	mov	r2,a
	jz	00114$
;	../../include/ztex-flash2.h:700: flash_ec = 0;
	mov	dptr,#_flash_ec
	clr	a
	movx	@dptr,a
;	../../include/ztex-flash2.h:701: spi_send_ep0();
	lcall	_spi_send_ep0
;	../../include/ztex-flash2.h:702: if ( flash_ec != 0 ) {
	mov	dptr,#_flash_ec
	movx	a,@dptr
	mov	r2,a
	jz	00114$
;	../../include/ztex-flash2.h:703: spi_deselect();
	lcall	_spi_deselect
;	../../include/ztex-conf.h:137: EP0CS |= 0x01;	// set stall
	mov	dptr,#_EP0CS
	movx	a,@dptr
...
;------------------------------------------------------------
;	../../include/ztex.h:241: void mac_eeprom_init ( ) { 
;	-----------------------------------------
;	 function mac_eeprom_init
;	-----------------------------------------
_mac_eeprom_init:
;	../../include/ztex.h:246: mac_eeprom_read ( buf, 0, 3 );	// read signature
	mov	_mac_eeprom_read_PARM_2,#0x00
	mov	_mac_eeprom_read_PARM_3,#0x03
	mov	dptr,#_mac_eeprom_init_buf_1_1
	lcall	_mac_eeprom_read
;	../../include/ztex.h:247: if ( buf[0]==67 && buf[1]==68 && buf[2]==48 ) {
	mov	dptr,#_mac_eeprom_init_buf_1_1
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x43,00102$
	...
	mov	r2,a
	cjne	r2,#0x30,00102$
;	../../include/ztex.h:248: config_data_valid = 1;
	mov	dptr,#_config_data_valid
	mov	a,#0x01
	movx	@dptr,a
;	../../include/ztex.h:249: mac_eeprom_read ( SN_STRING, 16, 10 );	// copy serial number
	...
	sjmp	00123$
00102$:
;	../../include/ztex.h:252: config_data_valid = 0;
	mov	dptr,#_config_data_valid
	clr	a
	movx	@dptr,a
;	../../include/ztex.h:255: for (b=0; b<10; b++) {	// abort if SN != "0000000000"
00123$:
	mov	r2,#0x00
00108$:
	cjne	r2,#0x0A,00133$
00133$:
	jnc	00111$
;	../../include/ztex.h:256: if ( SN_STRING[b] != 48 )
	mov	a,r2
	add	a,#_SN_STRING
	mov	dpl,a
	clr	a
	...
	movx	a,@dptr
	mov	r3,a
;	../../include/ztex.h:257: return;
	cjne	r3,#0x30,00116$
;	../../include/ztex.h:255: for (b=0; b<10; b++) {	// abort if SN != "0000000000"
	inc	r2
	sjmp	00108$
00111$:
;	../../include/ztex.h:260: mac_eeprom_read ( buf, 0xfb, 5 );	// read the last 5 MAC digits
	mov	_mac_eeprom_read_PARM_2,#0xFB
	mov	_mac_eeprom_read_PARM_3,#0x05
	mov	dptr,#_mac_eeprom_init_buf_1_1
	lcall	_mac_eeprom_read
;	../../include/ztex.h:262: c=0;
	mov	r2,#0x00
;	../../include/ztex.h:263: for (b=0; b<5; b++) {	// convert to MAC to SN string
	mov	r3,#0x00
00112$:
	cjne	r3,#0x05,00136$
00136$:
	jnc	00116$
;	../../include/ztex.h:264: d = buf[b];
	mov	a,r3
	...
	movx	a,@dptr
	mov	r4,a
;	../../include/ztex.h:265: SN_STRING[c] = hexdigits[d>>4];
	mov	a,r2
	add	a,#_SN_STRING
	mov	r5,a
	clr	a
	...
	mov	dph,r6
	movx	@dptr,a
;	../../include/ztex.h:266: c++;
	inc	r2
;	../../include/ztex.h:267: SN_STRING[c] = hexdigits[d & 15];
	mov	a,r2
	add	a,#_SN_STRING
	mov	r5,a
	clr	a
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex.h:317: void init_USB ()
;	-----------------------------------------
;	 function init_USB
;	-----------------------------------------
_init_USB:
;	../../include/ztex.h:319: USBCS |= bmBIT3;
	mov	dptr,#_USBCS
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../include/ztex.h:321: CPUCS = bmBIT4 | bmBIT1;
	mov	dptr,#_CPUCS
	mov	a,#0x12
	movx	@dptr,a
;	../../include/ztex.h:322: wait(2);
	mov	dptr,#0x0002
	lcall	_wait
;	../../include/ztex.h:323: CKCON &= ~7;
	anl	_CKCON,#0xF8
;	../../include/ztex.h:348: init_fpga();
	lcall	_init_fpga
;	../../include/ztex-fpga-flash2.h:105: fpga_flash_result= 255;
	mov	dptr,#_fpga_flash_result
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:353: EA = 0;
	clr	_EA
;	../../include/ztex.h:354: EUSB = 0;
	clr	_EUSB
...
;	../../include/ezintavecs.h:117: $0.addrL=(unsigned short)(&$1);
	...
	mov	a,r2
	movx	@dptr,a
;	../../include/ztex.h:375: EXIF &= ~bmBIT4;
	anl	_EXIF,#0xEF
;	../../include/ztex.h:376: USBIRQ = 0x7f;
	mov	dptr,#_USBIRQ
	mov	a,#0x7F
	movx	@dptr,a
;	../../include/ztex.h:377: USBIE |= 0x7f; 
	mov	dptr,#_USBIE
	movx	a,@dptr
	mov	r2,a
	orl	a,#0x7F
	movx	@dptr,a
;	../../include/ztex.h:378: EPIRQ = 0xff;
	mov	dptr,#_EPIRQ
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:379: EPIE = 0xff;
	mov	dptr,#_EPIE
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:381: EUSB = 1;
	setb	_EUSB
;	../../include/ztex.h:382: EA = 1;
	setb	_EA
;	../../include/ztex.h:305: EP$0CFG = bmBIT7 | bmBIT5;
	mov	dptr,#_EP1INCFG
	mov	a,#0xA0
	movx	@dptr,a
;	../../include/ezregs.h:46: __endasm;
...
;	../../include/ztex.h:402: flash_init();
	lcall	_flash_init
;	../../include/ztex.h:411: mac_eeprom_init();
	lcall	_mac_eeprom_init
;	../../include/ztex.h:417: fpga_configure_from_flash_init();
	lcall	_fpga_configure_from_flash_init
;	../../include/ztex.h:420: USBCS |= bmBIT7 | bmBIT1;
	mov	dptr,#_USBCS
	movx	a,@dptr
	orl	a,#0x82
	movx	@dptr,a
;	../../include/ztex.h:421: wait(10);
	mov	dptr,#0x000A
	lcall	_wait
;	../../include/ztex.h:423: USBCS &= ~bmBIT3;
	mov	dptr,#_USBCS
	movx	a,@dptr
	anl	a,#0xF7
	movx	@dptr,a
...
;------------------------------------------------------------
;------------------------------------------------------------
;	default.c:39: void main(void)	
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	default.c:41: init_USB();
	lcall	_init_USB
;	default.c:43: if ( config_data_valid ) {
	mov	dptr,#_config_data_valid
	movx	a,@dptr
	mov	r2,a
	jz	00104$
;	default.c:44: mac_eeprom_read ( (__xdata BYTE*) (productString+20), 6, 1 );
	mov	dptr,#(_productString + 0x0014)
	mov	_mac_eeprom_read_PARM_2,#0x06
	mov	_mac_eeprom_read_PARM_3,#0x01
	lcall	_mac_eeprom_read
;	default.c:47: while (1) {	}					//  twiddle thumbs
00104$:
	sjmp	00104$
	.area CSEG    (CODE)
	.area CONST   (CODE)
...
_manufacturerString:
	...
	.db 0x00
_productString:
	.ascii "USB-FPGA Module 2.13  (default)"
	.db 0x00
